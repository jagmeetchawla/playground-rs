# SPECS ARCHIVE — v1.2-pre (snapshot before v1.2 feedback session)

```
Status
- Version:  v1.2-pre
- Archived: 2026-03-31
- Note:     Snapshot of specifications.md before the v1.2 annotated-screenshot
            feedback session (2026-03-31). See specs/assets/v1.2-annotated-feedback.png.
```
